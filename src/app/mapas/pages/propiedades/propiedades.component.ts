...
/* para mostrar multiples mapas una la pantalla
 * colocar mapas pequeñas o multiples mapas en la misma pantalla
 * podemos crear multiples instancias del mapa y usarlas para mostrar informacion de locales
*/
